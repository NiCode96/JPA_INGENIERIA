...
const Cloudinary = () => {
    ...
    const preset_name = "imagenesJPAClouth";                         //16 Pegamos el "name" rescatado en el punto 24
    const cloud_name = "dauhxormz"                          //16.2 Pegamos el cloud_name rescatado en punto 20
